...
#define AMX_NO_DOCK         // Отключает встроенную поддержку динамических библиотек (не актуально для МК)
#define NO_DIR              // Отключает функции работы с директориями (требуют файловую систему)
#define AMX_DONT_RELOCATE   // Запрещает AMX модифицировать код в памяти (если вы выполняете его из Flash)

// Если в ваших скриптах не будет использоваться вещественная математика (float/double)
#define AMX_NO_FLOAT   
#undef  BYTE_ORDER
#define BYTE_ORDER    2
